...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', default ="data_digits_8_vs_9_noisy", type=str)
    parser.add_argument('--results_path',
        type=str,
        default='results',
        help='Path to folder where results are saved. Must exist already.')
    parser.add_argument('--alpha_grid', type=str, default='0.0001')
    parser.add_argument('--step_size', type=float, default=1.8)
    #a = 100, converges with 0.25, a=10000 converges with 0.005
    #a=1 converges at 0.5
